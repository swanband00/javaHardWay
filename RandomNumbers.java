public class RandomNumbers{
    public static void main( String[] args ){
        ...
        System.out.println("1-16:\t"+a+"\t"+b+"\t"+c+"\t"+d);
        ...
        a=1+(int)(11*Math.random());
        b=1+(int)(11*Math.random());
        c=1+(int)(11*Math.random());
        d=1+(int)(11*Math.random());
        System.out.println("10-20:\t"+a+"\t"+b+"\t"+c+"\t"+d);
        
        //pick three random integers, each 1-3
        a=1+(int)(1*Math.random());
        b=1+(int)(1*Math.random());
        c=1+(int)(1*Math.random());
        d=1+(int)(1*Math.random());
        System.out.println("1-3:\t"+a+"\t"+b+"\t"+c+"\t"+d);
        
        //pick four random integers, each 5-10
        a=1+(int)(5*Math.random());
        b=1+(int)(5*Math.random());
        c=1+(int)(5*Math.random());
        d=1+(int)(5*Math.random());
